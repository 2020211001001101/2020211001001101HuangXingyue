			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.HuangXingyue.model.Order o=(com.HuangXingyue.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.HuangXingyue.dao.UserDao userDao=new com.HuangXingyue.dao.UserDao();
						...
						<%
							...
							String paymentType=com.HuangXingyue.model.Payment.findByPaymentId(con,n);
							 %>
